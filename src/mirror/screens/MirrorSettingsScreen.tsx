...
const styles: Record<string, React.CSSProperties> = {
  ...
  dangerButton: {
    ...
    backgroundColor: skin.colors.errorAccent,
    color: 'white',
    border: 'none',
    borderRadius: skin.borders.radiusButton,
    fontFamily: skin.fonts.label,
    fontWeight: skin.fontWeights.bold,
    fontSize: skin.fontSizes.body,
    cursor: 'pointer',
  },
  versionContainer: {
    display: 'flex',
